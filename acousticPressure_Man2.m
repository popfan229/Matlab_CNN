...
%% ------ load pluse location
pluseLocation = xlsread('WaveLocation_v2.xls');
...
%         cuffPressure = cuffPressure(tRange);
        ...
        close(2);
%% ----
        fileRow = str2num(filename(1:end-5));
...
%         plot(t,soundOutCuff,'r');
        ...
        xlswrite('pulseNumV2.xls', pluseNum,1, ['A' num2str(fileRow+1)]); 
...
% -------
    ...
    function play_first(hObject, eventdata)
        ...
        firstStart=datestr(now, 'HH:MM:SS:FFF');
